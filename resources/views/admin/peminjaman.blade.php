...
<head>
    ...
    <title>{{ config('app.name', 'SIMBARA') }} - Admin Peminjaman</title>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="mb-6">
                    ...
                    <h1 class="text-2xl font-bold text-gray-900 mt-1">Peminjaman</h1>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                            <div>
                                <p class="text-sm text-gray-500">ID Mahasiswa</p>
                                <p class="font-medium text-gray-900">230856101</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Nama Mahasiswa</p>
                                <p class="font-medium text-gray-900">Andi Wiratama</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Item</p>
                                <p class="font-medium text-gray-900">Microphone (Wired)</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Jumlah</p>
                                <p class="font-medium text-gray-900">4</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Durasi</p>
                                <p class="font-medium text-gray-900">25/03/2025 - 25/03/2025</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                            ...
                            <div>
                                <p class="text-sm text-gray-500">Item</p>
                                <p class="font-medium text-gray-900">Mixer Audio</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Jumlah</p>
                                <p class="font-medium text-gray-900">4</p>
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-center">
                            ...
                            <div>
                                <p class="text-sm text-gray-500">Item</p>
                                <p class="font-medium text-gray-900">Projector</p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-500">Jumlah</p>
                                <p class="font-medium text-gray-900">4</p>
