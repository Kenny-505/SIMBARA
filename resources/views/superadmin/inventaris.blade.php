...
<div class="flex justify-between items-center mb-8">
    ...
    <div class="flex space-x-2">
        ...
        <a href="{{ route('superadmin.inventaris.audit') }}" 
                            ...
                            <div class="flex items-center">
                                ...
                                @else
                                    <div class="h-10 w-10 rounded-lg bg-gray-200 flex items-center justify-center mr-3">
                                        ...
                                        <!-- Debug info -->
                                        <div class="absolute text-xs bg-red-100 p-1 rounded z-10" style="font-size: 8px;">
                                            {{ $barang->foto_1 ? 'HAS: ' . strlen($barang->foto_1) : 'EMPTY' }}
                                        </div>
                                    </div>
                                @endif
                                <div>
