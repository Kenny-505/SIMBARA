...
@section('title', 'Dashboard - User Civitas Akademik')
...
<div class="bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-lg text-white p-6 mb-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-blue-100 mt-1">Civitas Akademik FMIPA</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="{{ route('user.gallery') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-300 transition-colors duration-200">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xs text-gray-500">Browse barang tersedia</p>
                </div>
            </a>

            <a href="{{ route('user.pengajuan.index') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-green-50 hover:border-green-300 transition-colors duration-200">
                <div class="flex-shrink-0">
            ...
            <a href="{{ route('user.peminjaman.index') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-purple-50 hover:border-purple-300 transition-colors duration-200">
                <div class="flex-shrink-0">
            ...
            <a href="{{ route('user.pengembalian.index') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-orange-50 hover:border-orange-300 transition-colors duration-200">
                <div class="flex-shrink-0">
...
<div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
    <div class="flex">
        ...
        <div class="ml-3">
            <h4 class="text-sm font-medium text-blue-800">Informasi Penting untuk Civitas Akademik</h4>
            <div class="mt-2 text-sm text-blue-700">
                <ul class="list-disc list-inside space-y-1">
                    <li>Sebagai civitas akademik, Anda <strong>tidak dikenakan biaya sewa</strong> untuk peminjaman barang</li>
